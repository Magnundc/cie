...
class M_contatoscrea extends CI_Model {
    ...
    public function salvar($data) {
        ...
        if (isset($data['id'])) {
            ...
            $result = $this->db->update('contatoscrea', $data);
        }else{
            $result = $this->db->insert('contatoscrea', $data);
        }
    ...
    public function excluir($id) {
        $this->db->where('id', $id);
        $result = $this->db->delete('contatoscrea');
