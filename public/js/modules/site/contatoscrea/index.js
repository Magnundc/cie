app.controller("ContatoscreaController", function($scope, $http, $timeout){
    var $ = jQuery;
    var ng = $scope;
    ...
    ng.reload = function(pg){
        atual = pg ? pg : 1;
        $http.get(base_url+'/contatoscrea/total').success(function(data){
        ...
        $http.get(base_url+'/contatoscrea/listar/'+limite+'/'+inicio+'/'+ordem+'/'+by+'/contatoscrea').success(function(data){
            ng.lista = data;
            $timeout(function () {
    ...
    ng.salvar = function(){
        $.ajax({
            url:base_url+'/contatoscrea/salvar',
            type:'post',
            data:ng.contatoscre,
    ...
    ng.delete = function(){
        $.ajax({
            url:base_url+'/contatoscrea/excluir/'+ng.contatoscre.id,
            type:'delete',
            dataType:'json',
            success:function(json){
