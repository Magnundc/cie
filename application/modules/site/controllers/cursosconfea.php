...
class Cursosconfea extends MX_Security{

    function __construct() {
        parent::__construct();
        $this->parser->setModule('site');
        $this->params = $this->uri->segment_array();
        $this->model = $this->load->model('m_cursosconfea');
    }

    public function index(){
        $this->parser->parse("cursosconfea/index");
    }
    ...
    public function pesquisa() {//função para pesquisar nome de cursos do confea        
        header('Content-type: application/json');
