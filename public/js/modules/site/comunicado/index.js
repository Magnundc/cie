app.controller("ComunicadoController", function($scope, $http, $timeout){
    var $ = jQuery;
    var ng = $scope;
    ...
    var loadDiplomasnaoreconhecidosgo = function(){
        $http.get(base_url+'/diplomasnaoreconhecidosgo/listar/1000/0/ASC/id/diplomasnaoreconhecidosgo').success(function(data){
            ng.diplomasnaoreconhecidosgo = data;
        });
    };

    ng.reload = function(pg){
        atual = pg ? pg : 1;
        $http.get(base_url+'/comunicado/total').success(function(data){
        ...
        $http.get(base_url+'/comunicado/listar/'+limite+'/'+inicio+'/'+ordem+'/'+by+'/comunicado').success(function(data){
            ng.lista = data;
            $timeout(function () {
    ...
    ng.salvar = function(){
        $.ajax({
            url:base_url+'/comunicado/salvar',
            type:'post',
            data:ng.comunicad,
    ...
    ng.delete = function(){
        $.ajax({
            url:base_url+'/comunicado/excluir/'+ng.comunicad.id,
            type:'delete',
            dataType:'json',
            success:function(json){
