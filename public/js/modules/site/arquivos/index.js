app.controller("ArquivosController", function($scope, $http, $timeout){
    var $ = jQuery;
    var ng = $scope;
    ...
    ng.reload = function(pg){
        atual = pg ? pg : 1;
        $http.get(base_url+'/arquivos/total').success(function(data){
        ...
        $http.get(base_url+'/arquivos/listar/'+limite+'/'+inicio+'/'+ordem+'/'+by+'/arquivos').success(function(data){
            ng.lista = data;
            $timeout(function () {
    ...
    ng.delete = function(){
        $.ajax({
            url:base_url+'/arquivos/excluir/'+ng.arquivo.id,
            type:'delete',
            dataType:'json',
            success:function(json){
    ...
    ng.editar = function(a){
        ng.arquivo = a;
        $("#modal-form").modal("show");
    };

    ng.excluir = function(a){
        ng.arquivo = a;
